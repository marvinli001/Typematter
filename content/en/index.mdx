...
status: experimental
version: 0.4.0-rc
description: Overview of Typematter's static-first docs shell, information model, and quality goals.
aliases:
  - home
  - overview
---
...
- [Components](/en/core-concepts/components)
- [Build validation](/en/api/build-validation)
