...
<Timeline>
  <ReleaseItem version="0.3.0-rc" date="2026-03-12" title="Core registry and Ask AI">
    Consolidated build-time registry, validation, standard search, and Ask AI delivery.
  </ReleaseItem>
  <ReleaseItem version="0.2.0-beta" date="2026-02-03" title="Expanded MDX primitives" status="Beta">
    Added new semantic blocks for annotation, details, steps, cards, badges, and math rendering.
  </ReleaseItem>
  <ReleaseItem version="0.1.0-alpha" date="2026-01-26" title="Initial docs shell" status="Alpha">
    Established the App Router docs shell, MDX rendering, navigation, and validation baseline.
  </ReleaseItem>
</Timeline>
